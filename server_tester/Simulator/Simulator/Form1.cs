    ...
    public partial class Form1 : Form
    {
        ...
        private async void connectBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Subscribe specifically to the three topics you want using string overloads compatible with this MQTTnet version
                ...
                try
                {
                    await _mqttClient.SubscribeAsync("music/#", MqttQualityOfServiceLevel.AtLeastOnce);
